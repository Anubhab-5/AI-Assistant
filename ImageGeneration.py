...
def open_images(prompt):
    ...
    for jpg_file in Files:
        ...
        try:
            # Try to open and dsplay the image
...
# API details for the Huggiing Face Stable Diffusion model
...
# Wrappaer function to generate and open images
